     ...
     clear: both;
      ...
      <body>
	     ...
	     <div class="row" style="position:relative; left:200px; top:-50px; bottom:0px; width:1100px;  display: block; margin: 0 auto; font-size: 12px; float: center;" >
		     ...
		     <div style=" top:5px;">
             <form method="get" action="index_GOV_V.php"><div class="column"><button type="submit" href="index_GOV.php"   id="Btn1" class="btnStyle span3">GOUVERNOURATS</button></div></form>
			  </div>
