...
<body class="loggedin">
		 ...
		 <!-- les Bouttons  -->
		     ...
		     <div class="row" style="position:relative; left:-150px; top:-45px; width:580px; text-align: center; display: block; margin: 0 auto; font-size: 11px;" >
		        <div style=" top:5px;">
			 <form method="get" action="index_REGION.php"> <div class="column"><button type="submit"  id="Btn2" class="btnStyle span3">REGIONS</button></div></form>
			    </div> 
			 <form method="get" action="index_GOV.php"> <div class="column"><button type="submit"  id="Btn3" class="btnStyle span3">GOUVERNOURATS</button></div></form>
		    ...
		    <div class="roww" style="position:relative; left: 100px; top:-85px; bottom:auto; width:580px; text-align: center; display: block; margin: 0 auto; font-size: 11px;" >
             ...
             <form method="get" action="index_Style_GOV.php"><div class="columnn"><button type="submit"  id="Btn1" class="btnStylee span3">Edit Gouvernourats</button></div></form>
			 <form method="get" action="index_Style_REGION.php"> <div class="columnn"><button type="submit"  id="Btn2" class="btnStylee span3">Edit Regions</button></div></form>
